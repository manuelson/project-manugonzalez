        ...
        <section className="d-md-flex header-banner justify-content-center">
            ...
            <div className="mx-5">
                ...
                <p className="text-grey justify-content-around text-banner">
                    ...
                    <a className="text-advice" href="https://php.net/"> PHP</a>,
                    <a className="text-advice" href="https://reactjs.org/"> React</a> and
                    <a className="text-advice" href="https://getbootstrap.com/"> Bootstrap CSS</a>
                </p>
            </div>
        </section>
    )
